...
function usage(exitCode = 0) {
  ...
  out.write(`Usage:
  node scripts/setup-data-mount.mjs --data-url <git-url-or-local-path> [--data-ref <ref>] [--root <repo-root>] [--force] [--dry-run]

Replaces the public _data skeleton with a user-supplied runtime data mount.

Local directories are copied into _data. Other URLs are added as a git submodule.
...
function setupDataMount(options) {
  ...
  const mode = localSource ? "copy" : "submodule";
