...
def simulate_url_filter(
    ...
    Args:
      ...
      snapshot_rules          : list of URL filter rule dicts (from _data/snapshot/<cloud>/zia/url-filtering-rules.json)
      snapshot_categories     : list of URL category dicts (from _data/snapshot/<cloud>/zia/url-categories.json)
