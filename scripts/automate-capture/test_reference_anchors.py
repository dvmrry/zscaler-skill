...
CASES = [
    AnchorCase(
        ...
        "vendor/zscaler-api-specs/automate-zscaler/rosetta.md:687-696",
    ...
    AnchorCase(
        ...
        "Use the rosetta table as the field-level index",
        "vendor/zscaler-api-specs/automate-zscaler/rosetta.md:2203-2211",
        "vendor/zscaler-api-specs/automate-zscaler/rosetta.md",
        2203,
        2211,
    ...
    AnchorCase(
        ...
        "vendor/zscaler-api-specs/automate-zscaler/rosetta.md:194",
        "vendor/zscaler-api-specs/automate-zscaler/rosetta.md",
        194,
        194,
    ...
    AnchorCase(
        ...
        "scripts/automate-capture/README.md:13-37",
    ...
    AnchorCase(
        ...
        "vendor/zscaler-api-specs/automate-zscaler/rosetta.md:185-187",
        "vendor/zscaler-api-specs/automate-zscaler/rosetta.md",
        185,
        187,
    ...
    AnchorCase(
        ...
        "vendor/zscaler-api-specs/automate-zscaler/rosetta.md:2274",
        "vendor/zscaler-api-specs/automate-zscaler/rosetta.md",
        2274,
        2274,
        ("bypassOnReauth",),
    ...
    AnchorCase(
        ...
        "vendor/zscaler-api-specs/automate-zscaler/openapi/openapi-validation-report.md:21",
    ...
    AnchorCase(
        ...
        "vendor/zscaler-api-specs/automate-zscaler/zia-divergences.json:5382",
    ...
    AnchorCase(
        ...
        "vendor/zscaler-api-specs/automate-zscaler/openapi/ai-security.openapi.json:49186-49202",
    ...
    AnchorCase(
        "references/ai-security/_claims-ledger.md",
        "The current Automate snapshot contains 97 structured AI Red Teaming",
        "vendor/zscaler-api-specs/automate-zscaler/openapi/ai-security.openapi.json:49186-49202",
        "vendor/zscaler-api-specs/automate-zscaler/openapi/ai-security.openapi.json",
        49186,
        49202,
    ...
    AnchorCase(
        ...
        "vendor/zscaler-api-specs/automate-zscaler/docusaurus-snapshot-compare-summary.md:133-165",
        "vendor/zscaler-api-specs/automate-zscaler/docusaurus-snapshot-compare-summary.md",
        133,
        165,
        ("identities-list-identities", "response_schema` added: `access_categories`", "response_schema` removed: `associated_source`"),
    ),
    AnchorCase(
        "references/zdx/api-divergences.md",
        "**Snapshot is Python-only**",
        "vendor/zscaler-api-specs/automate-zscaler/openapi-validation-report.md:154-155",
    ...
    AnchorCase(
        "references/zdx/api-divergences.md",
        "The current 2026-09-07 comparison matches",
        "vendor/zscaler-api-specs/automate-zscaler/docusaurus-snapshot-compare-summary.md:45-59",
        "vendor/zscaler-api-specs/automate-zscaler/docusaurus-snapshot-compare-summary.md",
        45,
        59,
        (
    ...
    AnchorCase(
        ...
        "the current publication is structurally validated",
        "vendor/zscaler-api-specs/automate-zscaler/openapi-validation-report.md:20",
        "vendor/zscaler-api-specs/automate-zscaler/openapi-validation-report.md",
        20,
        20,
        ("| `zid` | 31 | 18 | 0 |",),
    ...
    AnchorCase(
        ...
        "vendor/zscaler-api-specs/automate-zscaler/zpa-api-reference.json:83389-83401",
    ...
    AnchorCase(
        "references/_meta/clarifications.md",
        "**2026-06-18 narrowing**: the Automate contract confirms both paths",
        "vendor/zscaler-api-specs/automate-zscaler/zpa-api-reference.json:83458-83470",
        "vendor/zscaler-api-specs/automate-zscaler/zpa-api-reference.json",
        83458,
        83470,
    ...
    AnchorCase(
        "references/zbi/api.md",
        "**Automate contract scope:**",
        "vendor/zscaler-api-specs/automate-zscaler/zpa-api-reference.json:82556-82568",
        "vendor/zscaler-api-specs/automate-zscaler/zpa-api-reference.json",
        82556,
        82568,
    ...
    AnchorCase(
        "references/zbi/api.md",
        "**Automate contract scope:**",
        "vendor/zscaler-api-specs/automate-zscaler/zpa-api-reference.json:82849-82861",
        "vendor/zscaler-api-specs/automate-zscaler/zpa-api-reference.json",
        82849,
        82861,
    ...
    AnchorCase(
        "references/zbi/api.md",
        "**Automate contract scope:**",
        "vendor/zscaler-api-specs/automate-zscaler/zpa-api-reference.json:83142-83154",
        "vendor/zscaler-api-specs/automate-zscaler/zpa-api-reference.json",
        83142,
        83154,
    ...
    AnchorCase(
        "references/zbi/api.md",
        "**Automate contract scope:**",
        "vendor/zscaler-api-specs/automate-zscaler/zpa-api-reference.json:83337-83349",
        "vendor/zscaler-api-specs/automate-zscaler/zpa-api-reference.json",
        83337,
        83349,
    ...
    AnchorCase(
        ...
        "vendor/zscaler-api-specs/automate-zscaler/zpa-api-reference.json:103486-103498",
        "vendor/zscaler-api-specs/automate-zscaler/zpa-api-reference.json",
        103486,
        103498,
    ...
    AnchorCase(
        "references/shared/secret-bearing-api-surfaces.md",
        "The App Connector / Service Edge enrollment key is returned",
        "vendor/zscaler-api-specs/automate-zscaler/zpa-api-reference.json:103716-103728",
        "vendor/zscaler-api-specs/automate-zscaler/zpa-api-reference.json",
        103716,
        103728,
    ...
    AnchorCase(
        "references/shared/secret-bearing-api-surfaces.md",
        "The App Connector / Service Edge enrollment key is returned",
        "vendor/zscaler-api-specs/automate-zscaler/zpa-api-reference.json:103643-103652",
        "vendor/zscaler-api-specs/automate-zscaler/zpa-api-reference.json",
        103643,
        103652,
    ...
    AnchorCase(
        "references/shared/secret-bearing-api-surfaces.md",
        "The App Connector / Service Edge enrollment key is returned",
        "vendor/zscaler-api-specs/automate-zscaler/zpa-api-reference.json:103846-103855",
        "vendor/zscaler-api-specs/automate-zscaler/zpa-api-reference.json",
        103846,
        103855,
    ...
    AnchorCase(
        ...
        "vendor/zscaler-api-specs/automate-zscaler/openapi/openapi-validation-report.md:9",
        "vendor/zscaler-api-specs/automate-zscaler/openapi/openapi-validation-report.md",
        9,
        9,
        ("| `ai-security` | 114 | 105 | 0 |",),
    ),
    AnchorCase(
        "references/shared/oneapi.md",
        "The current structured Automate publication combines",
        "vendor/zscaler-api-specs/automate-zscaler/docusaurus-snapshot-compare-summary.md:27",
        "vendor/zscaler-api-specs/automate-zscaler/docusaurus-snapshot-compare-summary.md",
        27,
        27,
    ...
    AnchorCase(
        "references/shared/oneapi.md",
        "The current structured Automate publication combines",
        "vendor/zscaler-api-specs/automate-zscaler/docusaurus-snapshot-compare-summary.md:73-82",
        "vendor/zscaler-api-specs/automate-zscaler/docusaurus-snapshot-compare-summary.md",
        73,
        82,
        ("GET /v1/assets/agents", "GET /v1/resources/workloads"),
    ),
    AnchorCase(
        "references/shared/oneapi.md",
        "The current structured Automate publication combines",
        "vendor/zscaler-api-specs/automate-zscaler/openapi/ai-security.openapi.json:49186-49196",
        "vendor/zscaler-api-specs/automate-zscaler/openapi/ai-security.openapi.json",
        49186,
        49196,
        ("AI Red Teaming Service", "/aisecurity/airt", "/aisecurity/aispm"),
...
CASES.append(
    AnchorCase(
        "references/_meta/clarifications.md",
        "Separately from those eight absent callable methods",
        "vendor/zscaler-sdk-python/zscaler/aiguard/llm_application_credentials.py:308-312",
