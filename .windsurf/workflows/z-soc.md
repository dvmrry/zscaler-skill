...
5. **Use your file-read tool to load `agents/clarification-pattern.md`.** Multiple-choice with free-text escape for closed-set decisions (subtype selection, etc.).
<!-- adapter-deps:end -->
