...
2. **Use your file-read tool to load `agents/auditor/harness.md`.** This is the gate contract. It defines scope, mechanical-check, editorial-evidence, and register gates.
