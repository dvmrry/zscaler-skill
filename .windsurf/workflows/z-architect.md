...
3. **Use your file-read tool to load `agents/siem-emission-discipline.md`.** SIEM emission modes, public/private boundary, placeholder plumbing — applies when architect queries SIEMs for utilization.
<!-- adapter-deps:end -->
