...
argument-hint: [incident-dir] — e.g., "_data/cases/2026-05-14-ci-warning-regression/ write postmortem.md"
---
...
- `agents/retro/grounding/index.md` — postmortem grounding and decision-gate checks
