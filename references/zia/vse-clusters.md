...
The following items could not be sourced from the available vendor documents. They are registered in [`../_clarifications-sweep-2026-04.md`](../_clarifications-sweep-2026-04.md) under "Deferred — VSE clusters":
