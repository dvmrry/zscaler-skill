...
Go v3.8.41 introduced Endpoint DLP as several distinct management families, not only as fields on an inline DLP rule; the matching Python unified-client families introduced in v1.9.39 remain registered in current v1.9.41 (`vendor/zscaler-sdk-go/CHANGELOG.md:77-138`; `vendor/zscaler-sdk-python/CHANGELOG.md:32-113`; current version at `vendor/zscaler-sdk-python/pyproject.toml:1-4`; `vendor/zscaler-sdk-python/zscaler/zia/zia_service.py:849-919`):
