...
Use the rosetta table as the field-level index when a section below summarizes a resource rather than spelling out every field. It defines the `req`, `enum≠`, `enum1`, `ro`, `ro!`, and `type` markers (`vendor/zscaler-api-specs/automate-zscaler/rosetta.md:11-20`), treats Postman as reference-only rather than a constraint-bearing reconciliation leg (`vendor/zscaler-api-specs/automate-zscaler/rosetta.md:185-187`), and begins the ZPA resource table at `app_connector_group` (`vendor/zscaler-api-specs/automate-zscaler/rosetta.md:2203-2211`).
...
(`vendor/zscaler-api-specs/automate-zscaler/rosetta.md:11-20`, `vendor/zscaler-api-specs/automate-zscaler/rosetta.md:2274`). Keep
