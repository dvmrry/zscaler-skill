...
| **Business-to-Business Federation** — limited-availability partner trust, incoming/outgoing federation requests, federated-partner management, and application-segment federation with granular controls (`vendor/zscaler-help/zpa-release-upgrade-summary-2026-july.md:55-63`) | [`./b2b-federation.md`](./b2b-federation.md) | draft |
