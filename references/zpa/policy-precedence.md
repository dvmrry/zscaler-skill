...
- Wire-format schema for `_data/snapshot/zpa/access-policy-rules.json` (ruleOrder-as-string, operand tree, 19-value objectType enum) — [`./snapshot-schema.md`](./snapshot-schema.md)
