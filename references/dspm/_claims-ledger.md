...
| MCP has no product-specific DSPM tool in the audited source. | `overview.md` | AUDIT-SCOPED ABSENCE: no DSPM tool found in `vendor/zscaler-mcp-server` during the 2026-06-16 surface sweep. |
