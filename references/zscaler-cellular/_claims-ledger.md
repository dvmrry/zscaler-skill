...
| No product-specific Zscaler Cellular Go SDK, Terraform, or Ansible surface was found in the prior audited trees; those three absence claims were not re-audited during the MCP v0.13.4 refresh. | `overview.md`, `api.md` | AUDIT-SCOPED ABSENCE -> 2026-07-08 search across Go SDK, Terraform providers, and Ansible collections for ZCell / Zscaler Cellular service surfaces. |
| MCP v0.13.4 includes 20 read-only ZCell tools across nine API-aligned toolsets. | `index.md`, `overview.md`, `api.md` | `vendor/zscaler-mcp-server/docs/guides/supported-tools.md:489-514`; `vendor/zscaler-mcp-server/docs/guides/toolsets.md:137-149` |
