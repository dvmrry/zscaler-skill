...
| No product-specific Zscaler Cellular Go SDK, Terraform, or Ansible surface was found in the prior audited trees; those three absence claims were not re-audited during the MCP v0.14 refresh. | `overview.md`, `api.md` | AUDIT-SCOPED ABSENCE -> 2026-07-08 search across Go SDK, Terraform providers, and Ansible collections for ZCell / Zscaler Cellular service surfaces; current MCP release at `vendor/zscaler-mcp-server/CHANGELOG.md:3-30`. |
| MCP v0.14 includes 20 read-only ZCell tools across nine ZCell toolsets. | `index.md`, `overview.md`, `api.md` | `vendor/zscaler-mcp-server/CHANGELOG.md:3-30`; `vendor/zscaler-mcp-server/tests/test_docgen.py:119-123`; `vendor/zscaler-mcp-server/docs/guides/toolsets.md:141-153` |
