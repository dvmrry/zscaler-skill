...
| MCP v0.15 includes 20 read-only ZCell tools across nine ZCell toolsets; it does not expose the current tower-history operation, while its SDK-backed audit surface still retains audit metadata. | `index.md`, `overview.md`, `api.md` | `vendor/zscaler-mcp-server/CHANGELOG.md:140-159`; `vendor/zscaler-mcp-server/tests/test_docgen.py:119-123`; `vendor/zscaler-mcp-server/docs/guides/toolsets.md:141-153`; `vendor/zscaler-mcp-server/src/zscaler_mcp/tools/zcell/audit_data_handling.py:31-113` |
