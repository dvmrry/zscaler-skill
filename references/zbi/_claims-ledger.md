...
| Terraform ZPA registers CBI banner, certificate, external profile, v1/v2 isolation-rule resources, and CBI/isolation-profile data sources; the external-profile and v1 isolation-rule resources call create/update/delete paths. | `api.md`, `policy-integration.md` | `vendor/terraform-provider-zpa/zpa/provider.go:169-171`, `:181`, `:184`, `:239-245`; `vendor/terraform-provider-zpa/zpa/resource_zpa_cloud_browser_isolation_external_profile.go:262-278`, `:344-365`, `:372-378`; `vendor/terraform-provider-zpa/zpa/resource_zpa_policy_access_isolation_rule.go:11`, `:14-19`, `:27-34`, `:81-84`, `:113-118`, `:191-199`, `:228-230`, `:242-249` |
