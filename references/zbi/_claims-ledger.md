...
| Python `client.zbi` is Zscaler Business Insights, not Zero Trust Browser / Cloud Browser Isolation. | `index.md`, `overview.md`, `api.md`, `policy-integration.md` | `vendor/zscaler-sdk-python/zscaler/zbi/zbi_service.py:23-24`, `vendor/zscaler-sdk-python/zscaler/oneapi_client.py:230`, `:316-319` |
...
| Terraform ZPA registers CBI banner, certificate, external profile, isolation rule, and CBI/isolation-profile data sources; the external-profile and isolation-rule resources call create/update/delete paths. | `api.md`, `policy-integration.md` | `vendor/terraform-provider-zpa/zpa/provider.go:157-159`, `:169`, `:226-232`; `vendor/terraform-provider-zpa/zpa/resource_zpa_cloud_browser_isolation_external_profile.go:262-278`, `:344-365`, `:372-378`; `vendor/terraform-provider-zpa/zpa/resource_zpa_policy_access_isolation_rule.go:14-19`, `:27-34`, `:81-84`, `:113-118`, `:191-199`, `:228-230`, `:242-249` |
