...
| **Zscaler MCP Server runtime** — tool discovery, toolsets, entitlement filtering, read/write safety gates, deployment packaging, and vendor-drift notes from the vendored MCP server | [`./mcp-runtime.md`](./mcp-runtime.md) | draft |
