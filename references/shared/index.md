...
| **Windsurf runtime notes** (agent infrastructure) — how Windsurf processes `.windsurf/workflows/` and `.windsurf/rules/`; conventions for authoring workflow shims that work across CC and Windsurf | [`../../agents/_meta/windsurf-runtime-notes.md`](../../agents/_meta/windsurf-runtime-notes.md) | draft |
