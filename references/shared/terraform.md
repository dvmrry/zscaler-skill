...
- **Browser Access app segments**: setting `certificate_id` while `ext_label` or `ext_domain` is configured is rejected in code (`resource_zpa_application_segment_browser_access.go:48-57`).
