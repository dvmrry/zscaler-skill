...
| Apps & Infrastructure | AI Applications tab; app/LLM/detection/transaction counts; individual transactions and connected multi-prompt conversations. The body captured on **2026-08-04** says conversation-thread viewing is exclusive to DAS/API mode and does not appear in Proxy mode (`vendor/zscaler-help/ai-guard-apps-infrastructure-dashboard.md:4`, `:11-35`) | A separate **September 2, 2026** release entry announces Proxy-mode multi-turn conversation viewing. Treat this as a release/body disagreement, not a resolved current-state claim; the capture does not establish first-publication timing, tenant rollout, or API coverage (`vendor/zscaler-help/ai-guard-release-update-2026-09-02.md:7-11`, `:25-30`) |
...
- **Proxy-mode conversation view:** multi-turn conversation viewing in the AI
  ...
  reviewing each transaction separately (`vendor/zscaler-help/ai-guard-release-update-2026-09-02.md:7-11`).
...
evidence, which says Proxy-mode conversation viewing does not appear
