...
| The reconstructed Automate snapshot exposes a documented 47-operation AI Guard admin-plane contract, while the inspected Go SDK, Terraform, MCP, Postman, and Automation Hub client/source classes still do not wrap that admin plane. | `ai-guard-coverage.md`, `api-divergences.md`, `clarifications.md` | `vendor/zscaler-api-specs/automate-zscaler/openapi-validation-report.md:10`; `vendor/zscaler-api-specs/automate-zscaler/aiguard-api-reference.json:1`; `CLIENT-WRAPPER GAP -> references/ai-security/api-divergences.md#automate-admin-plane-contract-vs-client-surfaces` |
