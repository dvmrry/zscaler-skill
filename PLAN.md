...
7. **ZTW / ZTC (Zero Trust Workload / Cloud Connector)** — entirely Go-SDK-only product discovered during the cross-SDK sweep. Companion TF provider vendored. Would be the next net-new product to cover if fork team uses Cloud Connector.
